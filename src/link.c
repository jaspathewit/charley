/* File contains functions that create and destroy link structures
...
Function takes a pointer to the link structure to destroy
...
*/  
void destroy_link(LINK * this_link)
{  
/* logger freed memory */  
#ifdef DEBUG_MEM  
