...
if(log_file_name)  
    ...
    {  
	/* get pointer to start of the varibles */  
	va_start(ptr, format);      
...
Function takest the name of the log file to open  
