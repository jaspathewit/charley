/* File contains functions that create and distroy network structures  
...
/* Function distroy_network  
   
Function frees the memory allocated to a network  
   
Function takes a pointer to the network to distroy  
...
*/  
void distroy_network(NETWORK * this_net)  
{  
/* check that there is a network to distroy */ 
if(this_net) 
  { 
    /* distroy the links of this network */             
