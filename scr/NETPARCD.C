/* File contains functions that create and distroy net parameter structures  
...
void distroy_network_param(NETWORK_PARAM *);  
...
/* Function distroy_network_parameter  
   
Function frees the memory allocated to the network parameter structure   
   
Function takes a pointer to the network parameter structure to distroy  
...
*/  
void distroy_network_param(NETWORK_PARAM * this_network_param)  
{                       
