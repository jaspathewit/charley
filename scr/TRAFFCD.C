/* File contains functions that create and distroy traffic structures  
...
if(temp=(TRAFFIC *)malloc(sizeof(TRAFFIC)))  
	{                                    
...
/* Function distroy_traffic  
   
Function frees the memory allocated to a traffic structure   
   
Function takes a pointer to the traffic structure to distroy  
...
*/  
void distroy_traffic(TRAFFIC * this_traffic)  
{  
/* logger freed memory */  
#ifdef DEBUG_MEM  
