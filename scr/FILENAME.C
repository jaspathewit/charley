...
Function determins if the string is a drive  
...
Function determins if the string is a file_name  
...
if(success)  
	{  
		...
		/* try to process the file extention */  
...
Function determins if the string is a mask_name  
...
if(success)  
		...
		/* try to process the mask extention */  
...
Function determins if the string is a file extention  
  
Function takes a pointer to a pointer to the string to process  
  
Function returns true if the string contains a file extention  
...
Function determins if the string is a mask extention  
  
Function takes a pointer to a pointer to the string to process  
  
Function returns true if the string contains a mask extention  
...
Function determins if the string is a file id  
...
Function determins if the string is a mask id  
...
Function determins if the string is a period  
...
Function determins if the string is a slash  
...
Function determins if the string is a colon  
...
Function determins if the string is a string_end  
...
Function determins if the string is a rel_dir  
...
Function determins if the char is a valid file char  
...
Function determins if the char is a valid drive char  
...
Function determins if the char is a valid mask char  
