/* File contains functions that create and distroy node structures  
...
/* Function distroy_node  
   
Function frees the memory allocated to a node structure   
   
Function takes a pointer to the node structure to distroy  
...
*/  
void distroy_node(NODE * this_node)  
{                                         
/* logger freed memory */  
#ifdef DEBUG_MEM  
