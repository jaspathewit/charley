/* File contains functions that create and distroy route record structures  
...
void distroy_route_rec(ROUTE_REC *);  
...
if(temp=(ROUTE_REC *)malloc(sizeof(ROUTE_REC)))  
	{  
...
/* Function distroy_route_rec  
  
Function frees the memory allocated to a route_rec structure  
  
Function takes a pointer to the route_rec structure to distroy  
...
*/  
void distroy_route_rec(ROUTE_REC * this_route_rec)  
{  
/* logger freed memory */  
#ifdef DEBUG_MEM  
